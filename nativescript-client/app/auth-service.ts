...
export function tnsOauthLogout() {
  if (client) {
    ...
    client.logout();
    utils.openUrl(client.provider.tokenEndpointBase + "/connect/endsession?id_token_hint="+client.tokenResult. + "&post_logout_redirect_uri=" + encodeURI(client.provider.options.redirectUri));
